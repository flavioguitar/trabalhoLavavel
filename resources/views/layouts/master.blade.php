        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <div class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="{{ route('home') }}">Consultar Eventos</a></li>
                    <li><a href="{{ route('home') }}">Retirada de Bilhete</a></li>
                    <li><a href="{{ route('home') }}">Devolução de Bilhete</a></li>
                    <li><a href="{{ route('home') }}">Adquirir Bilhete</a></li>
                    <li class="dropdown">
